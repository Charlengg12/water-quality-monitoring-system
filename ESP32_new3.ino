...
unsigned long calibrationStartTime = 0;  // NEW: For pre-upload calibration timing
...
void setup() {
    ...
    if (!tcs.begin()) {
        ...
        Serial.println("\n========================================");
        Serial.println("SENSOR WARM-UP - ALL SENSORS");
        Serial.println("========================================");
        ...
        // Safe 20-second warmup with yield() to prevent watchdog
        for (int i = 20; i > 0; i--) {
        ...
        case DISPLAY_READINGS:
            if (currentMillis - displayGroupTimer >= DISPLAY_GROUP_TIME_MS) {
                ...
                if (displayGroupIndex <= 4) {
                    ...
                    // All readings displayed, now start pre-upload calibration
                    Serial.println("\n========================================");
                    ...
                    Serial.println("========================================");
                    Serial.println("\nStarting pre-upload sensor calibration...");
                    Serial.println("========================================\n");
        ...
        case PRE_UPLOAD_CALIBRATION:
            {
                ...
                if (remainingSeconds <= 0) {
                    ...
                    Serial.println("\n========================================");
                    Serial.println("Pre-upload calibration complete!");
                    Serial.println("========================================\n");
                    ...
                    // Update LCD every 2 seconds to reduce overhead
                    static unsigned long lastLCDUpdate = 0;
                    if (currentMillis - lastLCDUpdate >= 2000 || remainingSeconds <= 3) {
                    ...
                    if (currentMillis - lastSerialUpdate >= 1000) {
                    ...
                    // Keep web server responsive and prevent watchdog
                    server.handleClient();
                    delay(100);
                    yield();
                }
