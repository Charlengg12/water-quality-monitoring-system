...
void setup() {
    ...
    if (!tcs.begin()) {
        ...
        Serial.println("\n========================================");
        Serial.println("SENSOR CALIBRATION - ALL SENSORS");
        Serial.println("========================================");
        ...
        Serial.println("========================================");
        Serial.println("Calibrating all sensors for 20 seconds...\n");
        ...
        // Safe 20-second calibration countdown with yield() to prevent watchdog
        for (int i = 20; i > 0; i--) {
            // Update LCD only every 2 seconds to reduce overhead
            if (i % 2 == 0 || i <= 3) {
                lcd.setCursor(0, 2);
                lcd.print("Wait: ");
                lcd.print(i);
                if (i < 10) lcd.print(" "); // Clear extra digit
                lcd.print(" sec  ");
            }

            // Serial update every second
            Serial.print("Calibration: ");
            Serial.print(i);
            Serial.println(" seconds remaining...");

            // Split delay into smaller chunks with yield() to prevent watchdog reset
            for (int j = 0; j < 10; j++) {
                delay(100);  // 100ms x 10 = 1 second total
